  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  uint8_t counter = 0;
	 	  	  ...
	 	  	  while(counter < HUNDREDMILLISECONDS)
	 	  	  {
	 	  		  HAL_Delay(100);
	 	  		  if((HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_0) == GPIO_PIN_RESET) || (HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_1) == GPIO_PIN_RESET))
	 	  		  {
